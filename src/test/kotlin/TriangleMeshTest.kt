...
class TriangleMeshTest {
    ...
    fun testTranslation() {
        ...
        val mesh = TriangleMesh(
            ...
            indices = indicesList,
            transformation = Translation(Vector(1f, 1f, 1f))
        )
    ...
    @Test
    fun testRotation() {
        val verticesList = mutableListOf(
            Point(0f, 0f, 3f), Point(0f, 0.2f, 0f),
            Point(0.2f, 1f, 0f), Point(0f, -0.2f, 1f),
            Point(-0.2f, 0f, 0f), Point(0f, 0f, -3f)
        )

        val indicesList = mutableListOf(
            mutableListOf(0, 1, 2), mutableListOf(0, 2, 3), mutableListOf(0, 3, 4),
