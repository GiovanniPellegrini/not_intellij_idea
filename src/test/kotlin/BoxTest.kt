...
class BoxTest {
    ...
    fun testRayIntersectionTranslated() {
        ...
        dir.normalize()
        val box =
            Box(Pmax = Point(2f, 1f, 1f), Pmin = Point(0f, 0f, -1f), transformation = Translation(Vector(0f, 1f, 0f)))
    ...
    fun pointInternal() {
        ...
        val cube2 =
            Box(transformation = Translation(Vector(1f, 0f, 0f)), Pmin = Point(-1f, -1f, -1f), Pmax = Point(1f, 1f, 1f))
